...
<body>
	<div class="box-sign">
		...
		<form action=" <?php echo site_url("/UtilisateurCtrl/inserer");?> " method="post" class="right">
			<h2>Sign up</h2>
			<div class="item-sign">
				<label>Nom</label>
			...
			<div class="item-sign">
				<input type="submit" id="btnSign" value="S'inscrire">
			</div>
			<div class="item-sign">
				<a href="<?php echo site_url("/LoginCtrl/index");?>">Have an account?</a>
			</div>
	</form>
	</div>
